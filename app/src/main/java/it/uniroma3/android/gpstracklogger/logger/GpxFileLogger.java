...
public class GpxFileLogger {
    ...
    public void write() {
        try {
            ...
            xml.append("xmlns:chizroid=\"http://www.chizroid.info/ns/gpx\" ");
            xml.append("xsi:schemaLocation=\"http://www.topografix.com/GPX/1/1 ");
            xml.append("http://www.topografix.com/GPX/1/1/gpx.xsd ");
            xml.append("http://www.chizroid.info/ns/gpx http://www.chizroid.info/ns/gpx.xsd\">");
            xml.append("<trk>");
    ...
    public String getXMLTrackSegment() {
        ...
        for (TrackPoint point : track.getTrackPoints()) {
            ...
            trackSegment.append("<time>").append(point.getTime()).append("</time>");
